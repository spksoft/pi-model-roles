...
- Raise the intact task-text selection cap from 16,384 to 65,536 Unicode characters. Prompts above the old cap can now classify without shortening; larger prompts and selector-context overflows still use safe fallback.
